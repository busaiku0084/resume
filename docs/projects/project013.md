<details>
  ...
  <div>
    <ul>
      ...
      <li><strong>使用技術:</strong> <span>Python</span> <span>AWS</span> <span>Lambda</span> <span>API Gateway</span> <span>CI/CD</span> <span>Git</span> <span>Glue</span> <span>Athena</span> <span>Cloud Formation</span> <span>OpenAPI</span> </li>
    </ul>
  </div>
